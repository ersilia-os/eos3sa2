...
def eval_model(
        ...
        for train_size in train_set_sample_sizes:
            ...
            for run_idx in range(num_samples):
                ...
                with prefix_log_msgs(
                    ...
                    smiles_list = [m.smiles for m in task_sample.test_samples]
                    print(smiles_list)
                    print("probabilities")
                    print(test_metrics)
    ...
    with open(output_path, 'w') as f:
        for line in smiles_list:
            ...
            #write_csv_summary(os.path.join(out_dir, f"{task.name}_eval_results.csv"), test_metrics)
